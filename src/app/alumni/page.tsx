...
function SectionHeading({
  ...
  return (
    ...
    >
      ...
      <h2 className="mt-3 text-3xl font-semibold tracking-tight text-brand-deepteal sm:text-4xl md:text-5xl">
        {title}
      </h2>
      ...
      <main className="min-h-screen bg-white text-slate-950">
        ...
        >
            <div className="flex flex-col justify-center gap-3 sm:flex-row">
              ...
              <a
                href="#support"
                className="inline-flex items-center justify-center gap-2 rounded-xl bg-brand-yellow px-5 py-3 text-sm font-semibold text-brand-deepteal transition duration-300 hover:-translate-y-1 hover:bg-yellow-300"
              >
                Ways to Support
                <ArrowIcon />
              </a>
            ...
            <div className="grid gap-5 md:grid-cols-3">
              {engagementCards.map((card, index) => (
                <motion.article
                  ...
                  className="rounded-2xl border border-slate-200 bg-brand-slate p-6 shadow-sm transition duration-300 hover:-translate-y-1 hover:bg-white hover:shadow-lg"
                >
                  <h3 className="text-xl font-semibold text-brand-deepteal">
                    {card.title}
                  </h3>
            ...
            <div className="grid gap-5 md:grid-cols-3">
              {officialLinks.map((link, index) => (
                ...
                >
                  ...
                  <h3 className="mt-3 text-xl font-semibold text-brand-deepteal">
                    {link.title}
                  </h3>
                  <p className="mt-3 text-sm leading-6 text-slate-600">
                    {link.description}
                  ...
                  <p className="mt-5 inline-flex items-center gap-2 text-sm font-semibold text-brand-teal">
                    Open Link
                    <ArrowIcon />
                  </p>
                </motion.a>
            ...
            <div className="grid gap-5 md:grid-cols-2">
              {supportPathways.map((item, index) => (
                <motion.article
                  ...
                  className="rounded-2xl border border-slate-200 bg-brand-slate p-6 shadow-sm"
                >
                  <div className="flex items-start gap-4">
                    <div className="flex h-10 w-10 flex-none items-center justify-center rounded-full bg-brand-teal text-sm font-semibold text-white">
                      {index + 1}
                    </div>
        ...
        {/* CTA */}
        <section className="bg-gradient-to-br from-brand-mint via-white to-yellow-50 py-20">
          <div className={`mx-auto w-full ${pagePadding}`}>
            <motion.div
              initial={{ opacity: 0, y: 24 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              <h2 className="mt-3 text-3xl font-semibold tracking-tight text-brand-deepteal md:text-5xl">
